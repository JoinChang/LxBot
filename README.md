...
韵律源点查询适配新版曲目查询（3.0.0c）。

韵律源点查询适配新版搭档（3.0.0c）。

修改了韵律源点查询的新版曲目定数与定数名（3.0.0c）。

*新版本仍有部分特性未被适配，将在未来更新

Phigros 查询适配 1.4.4 版本。

修复了 osu! 查询无法获取最近成绩的问题。

*本次更新由 Tomorrowgas 大神提供相关支持
